...
//   // 其他全局配置项...
// }
// AppConfigService 负责加载和存储全局应用配置，供整个应用使用。
// 你可以在应用启动时（例如在 AppComponent 的 ngOnInit 中）调用 AppConfigService.load() 方法来加载配置。
// 例如：
...
// Load backend configuration, such as API base URL, feature flags, etc.
